...
- **A common capacity measure with both charged problems solved.** A
  universal conditional identity, an opposing virtual-value sign certificate
  and four sparse long-range IC cycles support both unrestricted charged
  screening values at zero. An exact gap identity separates screening,
