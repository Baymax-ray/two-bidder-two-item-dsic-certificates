...
LOWER_FLOOR = Fraction(437909927074211227673, 500000000000000000000)
...
def check_text_consistency(recorder: Recorder) -> None:
    ...
    require(Fraction(joint_manifest["lower_floor"]) == LOWER_FLOOR,
            "joint lower floor differs from release theorem")
    require(Fraction(joint_manifest["upper"]) == UPPER,
    ...
    require(LOWER_FLOOR / UPPER > Fraction(988779, 1000000),
            "exact endpoints do not certify the stated 98.8779% guarantee")
    for text, label in ((manuscript, "manuscript"), (readme, "README")):
        require("98.8779" in text,
        ...
        require("0.8758198541484224553460" in text
                and "0.8758198541484224553461" in text,
                f"new exact revenue enclosure missing from {label}")
        require("0.0099384483702321295386" in text,
