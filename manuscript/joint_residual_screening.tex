...
They are conditional certificates. A common measure is constructed in
Section~\ref{sec:common-upper}; requiring that measure to match a jointly
feasible candidate remains a separate, unresolved condition.
...
\]
This establishes the historical V4.6 lower bound. The active lower claim
in Theorem~\ref{thm:bracket} follows from Proposition~\ref{prop:refined-feasible}.
The historical mechanism improves
